...
public class AirbusA320 extends Airplane {
    ...
    public AirbusA320() {
    	System.out.print("[AirbusA320] Constructor of AirbusA320 loaded.");
    }
    
    public AirbusA320(boolean fbwe, double mrk, String airlineName, String name,
    		          double wingspan, double altitude) {
    	System.out.print("[AirbusA320] Constructor of AirbusA320 with parameters loaded.");
	...
	public void activateFlyByWire() {
        if (flyByWireEnabled) {
            System.out.println("[AirbusA320] Fly-by-wire system activated.");
        } else {
            System.out.println("[AirbusA320] Fly-by-wire not supported on this model.");
        }
    }

    public void deactivateFlyByWire() {
        System.out.println("[AirbusA320] Fly-by-wire system deactivated.");
    }
    
    public String start() {
		return "[AirbusA320] AirbusA320 is starting!";
